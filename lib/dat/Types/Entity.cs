...
// Original: https://github.com/LandSandBoat/FFXI-NavMesh-Builder-/blob/master/src/FFXI%20Navmesh%20Builder/Common/dat/Types/Entity.cs
// ***********************************************************************
...
namespace Ffxi_Navmesh_Builder.Common.dat.Types {
  ...
  public class Entity {
    ...
    public void ParseNpcDat(byte[] data) {
      ...
      for (var i = 0; i < data.Length;) {
        ...
        int targetIndex;
        int zoneId;
        var name = Encoding.ASCII.GetString(data, i, 28).TrimEnd('\0');
        if (name == "none") {
          serverID = 0;
          targetIndex = 0;
        ...
        if (name != "none") {
          serverID = BitConverter.ToUInt32(data, i + 28);
