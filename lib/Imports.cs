...
namespace Ffxi_Navmesh_Builder.Common {
  ...
  public class Ffxinav : IDisposable {
    ...
    public void ChangeNavMeshSettings(double cellSize,
                                      double cellHeight,
                                      double agentHeight,
                                      double agentRadius,
                                      double maxClimb,
                                      ...
                                      double edgeError,
                                      double vertsPp,
                                      double detailSampDistance,
                                      double detailMaxError,
                                      bool debugMode) {
      navMeshSettings(_mPNativeObject,
                      cellSize,
                      cellHeight,
                      agentHeight,
                      agentRadius,
    ...
    public bool IsNavMeshEnabled() {
      if (isNavMeshEnabled(_mPNativeObject) == false)
        return false;
    ...
    [DllImport("FFXINAV.dll",
               EntryPoint = "CanSeeDestination",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    [return: MarshalAs(UnmanagedType.I1)]
    private static extern bool CanSeeDestination(IntPtr pFfxiNavClassObject,
                                                 PositionT start,
                                                 PositionT end);
    ...
    [DllImport("FFXINAV.dll",
               EntryPoint = "DisposeFFXINavClass",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    ...
    /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
    [DllImport("FFXINAV.dll",
               EntryPoint = "EnableNearestPoly",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    [return: MarshalAs(UnmanagedType.I1)]
    private static extern bool EnableNearestPoly(IntPtr pFfxiNavClassObject,
                                                 PositionT pos,
                                                 bool enable,
                                                 bool useCustomMesh);
    ...
    /// if meshes were built with obj's files from noesis <c> true </c> [use custom].</param>
    [DllImport("FFXINAV.dll",
               EntryPoint = "FindClosestPath",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    private static extern void FindClosestPath(IntPtr pFfxiNavClassObject,
                                               PositionT start,
                                               PositionT end,
    ...
    [DllImport("FFXINAV.dll",
               ...
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    private static extern void findPath(IntPtr pFfxiNavClassObject,
                                        PositionT start,
                                        PositionT end,
                                        bool useCustomNavMesh);
    ...
    /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
    [DllImport("FFXINAV.dll",
               EntryPoint = "FindRandomPath",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    [return: MarshalAs(UnmanagedType.I1)]
    private static extern bool FindRandomPath(IntPtr pFfxiNavClassObject,
                                              PositionT start,
                                              float maxRadius,
                                              sbyte maxTurns,
                                              bool useCustom);
    ...
    /// <returns>System.SByte.</returns>
    [DllImport("FFXINAV.dll",
               EntryPoint = "GetRotation",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    private static extern sbyte GetRotation(IntPtr pFfxiNavClassObject,
                                            PositionT start,
                                            PositionT end);
    ...
    [DllImport("FFXINAV.dll",
               EntryPoint = "IsValidPosition",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    [return: MarshalAs(UnmanagedType.I1)]
    private static extern bool IsValidPosition(IntPtr pFfxiNavClassObject,
                                               PositionT start,
                                               bool useCustom);
    ...
    [DllImport("FFXINAV.dll",
               EntryPoint = "NavMeshSettings",
               CharSet = CharSet.Auto,
               CallingConvention = CallingConvention.Cdecl,
               SetLastError = true)]
    private static extern void navMeshSettings(IntPtr pFfxiNavClassObject,
                                               double cellSize,
                                               double cellHeight,
                                               double agentHight,
                                               double agentRadius,
    ...
    private PositionT[] Get_WayPoints_Wrapper() {
      ...
      for (var x = 0; x < numberOfElements; x++) {
        var unmanagedPointerToVectorEntry =
          new IntPtr(unmanagedPointerToVector.ToInt32() + x * sizeOfElement);
        returnArray[x] =
          (PositionT)Marshal.PtrToStructure(unmanagedPointerToVectorEntry, typeof(PositionT));
      }
    ...
    public abstract class ItemsSafeHandle : SafeHandleZeroOrMinusOneIsInvalid {
      ...
      /// </summary>
      protected ItemsSafeHandle() : base(true) {}
