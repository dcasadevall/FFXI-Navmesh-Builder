...
// ***********************************************************************
// <copyright file="TopazNames.cs" company="Xenonsmurf">
...
namespace FFXI_Navmesh_Builder.Common {
  ...
  public class TopazNames {
    ...
    /// The zone names
    /// </summary>
    public static IDictionary<int, string> zoneNames = new Dictionary<int, string>() {
      { 0, "unknown" },
      { 1, "Phanauet_Channel" },
      ...
      { 227, "Ship_bound_for_Selbina_Pirate" },
